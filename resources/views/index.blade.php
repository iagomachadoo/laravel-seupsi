...
@section('conteudo')
    ...
    <section class="atendimento">
        <div class="container px-3 py-5">
            <h1 class="atendimento__titulo font-xxl mb-3">Como faço para marcar um <br> atendimento?</h1>
    ...
    <section class="duvidas">
        <div class="container px-3 py-5">
            <h2 class="duvidas__titulo font-xxl mb-4">Perguntas frequentes.</h2>
        ...
        <div class="container px-3 py-5">
            <div class="row">
                <div class="col-lg-7 d-flex flex-column justify-content-center order-lg-1 order-2 sobre__conteudo">
                    <h2 class="mb-4 sobre__titulo font-xxl">Conheça o Fellype.</h2>
    ...
    <section class="mensagens">
        <div class="container py-5">
            <h2 class="mb-3 mensagens__titulo font-xxl">Caixa de mensagens.</h2>
            ...
            <div class="mensagens__conteudo">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                    <ul class="carousel-indicators mensagens__corousel-lista">
                    ...
                    <ul class="carousel-inner p-0">
                        @foreach ($depoimentos as $depoimento)
                            <li class="carousel-item {{$loop->index ? '' : 'active'}}">
                                <h3 class="text-center mb-4 mensagens__carousel-titulo font-m">{{$depoimento->idade . ' anos - ' . $depoimento->cidade}}</h3>
            ...
            <a href="{{ route('mensagens') }}" class="mensagens__link font-s-b mt-5 d-inline-block">deixe sua mensagem</a>
        </div>
    </section>
@endsection