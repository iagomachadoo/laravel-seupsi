...
@section('conteudo')
    <div class="container py-5">
        <h1 class="form-mensagen__titulo font-xxl mb-5">Caixe de mensagens.</h1>
        <form action="{{ route('mensagens-post') }}" method="post" {{-- data-grecaptcha-action="mensagens" --}}>
            @csrf
            ...
            <div class="form_mensagem__campo d-flex flex-column mb-4">
                ...
                <textarea name="mensagem" id="mensagem" cols="60" rows="10" maxlength="350" value="{{old('mensagem')}}" required class="mb-1 py-1 px-2 form_mensagem__text-area"></textarea>
